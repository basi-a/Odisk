...
mkcert -cert-file $CRT_FILE_NAME -key-file $PRIVATE_KEY_FILE_NAME \
    "*.basi-a.top" localhost 127.0.0.1 ::1 172.30.20.1 172.30.20.100 172.30.20.13 172.30.20.20 172.30.20.21 172.30.20.22 172.30.20.23 minio1 minio2 minio3 minio4
